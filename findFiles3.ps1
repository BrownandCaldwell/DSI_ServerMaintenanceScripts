...
#Get-FolderItem $path | Export-Csv -Path .\Files.csv -NoTypeInformation

#Add-Type -assembly "system.io.compression.filesystem"
#[io.compression.zipfile]::CreateFromFile(".\Files.csv", "_CompressedFiles.zip")
#Compress-Archive -LiteralPath .\Files.csv -DestinationPath $env:COMPUTERNAME"_CompressedFiles" -Force

#robocopy .\ \\keydbsdev.bc.com\Branch2Cloud $env:COMPUTERNAME"_CompressedFiles.zip" /r:0 
